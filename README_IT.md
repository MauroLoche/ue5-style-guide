...
- [2. Struttura della directory dei contenuti](#structure)
  ...
  - [2.2 Usa una cartella Top Level per assets Project Specific](#structure-top-level)
    ...
    - [2.2.2 Riduci Migration Conflicts](#2.2.2)
      - [2.2.2e1 Esempio di Master Material](#2.2.2e1)
    - [2.2.3 Samples, Templates, and Marketplace Content sono senza rischi](#2.2.3)
    - [2.2.4 DLC, Sub-Projects, and Patches sono facili da Easily Maintained](#2.2.4)
